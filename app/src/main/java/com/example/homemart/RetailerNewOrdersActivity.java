...
import com.example.homemart.model.RetailerOrders;
...
public class RetailerNewOrdersActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<RetailerOrders> options =
                ...
                .setQuery(ordersRef, RetailerOrders.class).build();
        ...
        FirebaseRecyclerAdapter<RetailerOrders, RetailerOrdersViewHolder > adapter =
                new FirebaseRecyclerAdapter<RetailerOrders, RetailerOrdersViewHolder>(options) {
                    @Override
                    protected void onBindViewHolder(@NonNull RetailerOrdersViewHolder retailerOrdersViewHolder, int i, @NonNull RetailerOrders retailerOrders) {
                        retailerOrdersViewHolder.userName.setText("Name: " + retailerOrders.getName());
                        retailerOrdersViewHolder.userPhoneNumber.setText("Phone no. : " + retailerOrders.getPhone());
                        retailerOrdersViewHolder.userDateTime.setText("Order at: " + retailerOrders.getDate()+ " " + retailerOrders.getTime());
                        retailerOrdersViewHolder.userShippingAddress.setText("Shipping Address: " + retailerOrders.getAddress() + ", " + retailerOrders.getCity() + ", " + retailerOrders.getPincode());
                        retailerOrdersViewHolder.userTotalPrice.setText("Total Amount: Rs." + retailerOrders.getTotalAmount());

                        retailerOrdersViewHolder.ShowOrdersBtn.setOnClickListener(new View.OnClickListener() {
                            @Override
                        ...
                        retailerOrdersViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
